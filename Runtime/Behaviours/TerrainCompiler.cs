...
namespace jedjoud.VoxelTerrain.Generation {
    public class TerrainCompiler : MonoBehaviour {
        [HideInInspector]
        ...
        public void Parse() {
            TerrainGraph graph = GetComponent<TerrainGraph>();
            ...
            TerrainGraph.VoxelInput voxelInput = new TerrainGraph.VoxelInput() { position = (Variable<float3>)position.node };
            graph.Voxels(voxelInput, out TerrainGraph.VoxelOutput voxelOutput);
            ...
            TerrainGraph.PropInput propInput = new TerrainGraph.PropInput() {
            ...
            TerrainGraph.PropContext propContext = new TerrainGraph.PropContext();
