...
namespace jedjoud.VoxelTerrain.Editor {
    [CustomEditor(typeof(TerrainCompiler), true)]
    public class TerrainCompilerEditor : UnityEditor.Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            var script = (TerrainCompiler)target;
            ...
            if (script.GetComponent<TerrainGraph>() == null) {
            ...
            if (GUILayout.Button("Recompile")) {
                script.Compile(true);
                script.GetComponent<TerrainPreview>()?.OnPropertiesChanged();
            }
